...
// Center square
const w = `conic-gradient(from 45deg, ${y} 0deg, ${y} 90deg, ${b} 90deg, ${b} 180deg, ${r} 180deg, ${r} 270deg, ${g} 270deg)`;
// Bottom left corner
