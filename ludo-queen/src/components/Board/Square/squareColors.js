...
const red = '#ff0000';
  ...
  const blue = '#3f51b5';
  const yellow = '#ffeb3b';
  const topL = "linear-gradient(45deg, #ff0000 50%, #4caf50 50%) no-repeat";
  const topR = "linear-gradient(-45deg, #ffeb3b 50%, #4caf50 50%) no-repeat";
  ...
  const btmL = "linear-gradient(-45deg, #3f51b5 50%, #ff0000 50%) no-repeat";
  const btmR = "linear-gradient(45deg, #3f51b5 50%, #ffeb3b 50%) no-repeat";
